...
server <- function(input, output, session) { 
    ...
    observeEvent(toListen(), {
        ...
        updateSelectInput(inputId = "tp1.cluster", label = "Cluster", choices = unique(vals$clusters$actual.tp1.cluster),  selected = NULL)
        updateSelectInput(inputId = "timepoint", label = "Time point", choices = unique(vals$clusters$interval), selected = NULL)
